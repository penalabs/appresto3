...
class Menu_model extends CI_Model
{
    ...
    // datatables
    function json($where) {
        $this->datatables->select('tbl_menu.id_menu,title,url,icon,is_main_menu,is_aktif');
        $this->datatables->from('tbl_menu');
        $this->datatables->add_column('is_aktif', '$1', 'rename_string_is_aktif(is_aktif)');
        $this->datatables->where($where);
        //add this line for join
        $this->datatables->join('tbl_hak_akses', 'tbl_menu.id_menu = tbl_hak_akses.id_menu');
	...
	function update_hak_akses($id_menu, $data)
    {
        $this->db->where('id_menu', $id_menu);
        $this->db->update('tbl_hak_akses', $data);
    }
