...
class Pengajuan_biaya_operasional_cabang_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('pengajuan_biaya_operasional_cabang/read/$1'),'<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm'))." 
            ".anchor(site_url('pengajuan_biaya_operasional_cabang/update/$1'),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm'))." 
            ...
            ".anchor(site_url('pengajuan_biaya_operasional_cabang/delete/$1'),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'biaya_operasional_id');
...
/* End of file Pengajuan_biaya_operasional_cabang_model.php */
/* Location: ./application/models/Pengajuan_biaya_operasional_cabang_model.php */
