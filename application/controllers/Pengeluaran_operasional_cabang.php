...
class Pengeluaran_operasional_cabang extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        
        $this->load->model('Pengeluaran_operasional_cabang_model');
    ...
    {
        $this->template->load('template','pengeluaran_operasional_cabang/biaya_operasional_cabang_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Pengeluaran_operasional_cabang_model->json();
    }

    public function read($id) 
    {
        $row = $this->Pengeluaran_operasional_cabang_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'kas_id' => $row->kas_id,
            ...
            $this->template->load('template','pengeluaran_operasional_cabang/biaya_operasional_cabang_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('pengeluaran_operasional_cabang'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('pengeluaran_operasional_cabang/create_action'),
        ...
        $this->template->load('template','pengeluaran_operasional_cabang/biaya_operasional_cabang_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'kas_id' => $this->input->post('kas_id',TRUE),
            ...
            $this->Pengeluaran_operasional_cabang_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('pengeluaran_operasional_cabang/update_action'),
    ...
    public function update_action() 
    {
		...
		'kas_id' => $this->input->post('kas_id',TRUE),
            ...
            $this->Pengeluaran_operasional_cabang_model->update($this->input->post('biaya_operasional_id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Pengeluaran_operasional_cabang_model->delete($id);
	...
	foreach ($this->Pengeluaran_operasional_cabang_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'biaya_operasional_cabang_data' => $this->Pengeluaran_operasional_cabang_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('pengeluaran_operasional_cabang/biaya_operasional_cabang_doc',$data);
    }

}

/* End of file Pengeluaran_operasional_cabang.php */
/* Location: ./application/controllers/Pengeluaran_operasional_cabang.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2022-10-15 19:55:54 */
/* http://harviacode.com */