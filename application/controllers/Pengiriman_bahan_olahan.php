...
class Pengiriman_bahan_olahan extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        
        $this->load->model('Pengiriman_bahan_olahan_model');
    ...
    {
        $this->template->load('template','pengiriman_bahan_olahan/pengiriman_bahan_olahan_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Pengiriman_bahan_olahan_model->json();
    }

    public function read($id) 
    {
        $row = $this->Pengiriman_bahan_olahan_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'status' => $row->status,
            ...
            $this->template->load('template','pengiriman_bahan_olahan/pengiriman_bahan_olahan_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('pengiriman_bahan_olahan'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('pengiriman_bahan_olahan/create_action'),
        ...
        $this->template->load('template','pengiriman_bahan_olahan/pengiriman_bahan_olahan_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'status' => $this->input->post('status',TRUE),
            ...
            $this->Pengiriman_bahan_olahan_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('pengiriman_bahan_olahan/update_action'),
    ...
    public function update_action() 
    {
		...
		'status' => $this->input->post('status',TRUE),
            ...
            $this->Pengiriman_bahan_olahan_model->update($this->input->post('pengiriman_bahan_olahan_id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Pengiriman_bahan_olahan_model->delete($id);
	...
	foreach ($this->Pengiriman_bahan_olahan_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'pengiriman_bahan_olahan_data' => $this->Pengiriman_bahan_olahan_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('pengiriman_bahan_olahan/pengiriman_bahan_olahan_doc',$data);
    }
    public function status_dikirim($bahan_olahan_id) 
    {
            ...
            $this->Pengiriman_bahan_olahan_model->update($bahan_olahan_id, $data);
            $this->session->set_flashdata('message', 'Update Record Success');
            redirect(site_url('pengiriman_bahan_olahan'));
...
/* End of file Pengiriman_bahan_olahan.php */
/* Location: ./application/controllers/Pengiriman_bahan_olahan.php */
