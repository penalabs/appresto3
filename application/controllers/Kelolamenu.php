...
class Kelolamenu extends CI_Controller
{
    ...
    public function json() {
        ...
        $where = array('tbl_hak_akses.id_user_level' => $this->session->userdata('id_user_level'));
        echo $this->Menu_model->json($where);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $last_id=$this->Menu_model->insert($data);
			...
			$this->Menu_model->insert_hak_akses($data2);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Menu_model->update_hak_akses($this->input->post('id_menu', TRUE), $data2);
