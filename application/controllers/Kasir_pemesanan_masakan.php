...
class Kasir_pemesanan_masakan extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        
        $this->load->model('Kasir_pemesanan_masakan_model');
    ...
    {
        $this->template->load('template','kasir_pemesanan_masakan/pemesanan_masakan_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Kasir_pemesanan_masakan_model->json();
    }

    public function read($id) 
    {
        $row = $this->Kasir_pemesanan_masakan_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'status' => $row->status,
            ...
            $this->template->load('template','kasir_pemesanan_masakan/pemesanan_masakan_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('kasir_pemesanan_masakan'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('kasir_pemesanan_masakan/create_action'),
        ...
        $this->template->load('template','kasir_pemesanan_masakan/pemesanan_masakan_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'status' => $this->input->post('status',TRUE),
            ...
            $this->Kasir_pemesanan_masakan_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('kasir_pemesanan_masakan/update_action'),
    ...
    public function update_action() 
    {
		...
		'status' => $this->input->post('status',TRUE),
            ...
            $this->Kasir_pemesanan_masakan_model->update($this->input->post('pemesanan_maakan_id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Kasir_pemesanan_masakan_model->delete($id);
	...
	foreach ($this->Kasir_pemesanan_masakan_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'pemesanan_masakan_data' => $this->Kasir_pemesanan_masakan_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('kasir_pemesanan_masakan/pemesanan_masakan_doc',$data);
    }

}

/* End of file Kasir_pemesanan_masakan.php */
/* Location: ./application/controllers/Kasir_pemesanan_masakan.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2022-10-19 13:58:07 */
/* http://harviacode.com */