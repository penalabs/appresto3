...
class Investasi_generalmanager extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        
        $this->load->model('Investasi_generalmanager_model');
    ...
    {
        $this->template->load('template','investasi_generalmanager/investasi_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Investasi_generalmanager_model->json();
    }

    public function read($id) 
    {
        $row = $this->Investasi_generalmanager_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'id_users_generalmaanager' => $row->id_users_generalmaanager,
            ...
            $this->template->load('template','investasi_generalmanager/investasi_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','investasi_generalmanager/investasi_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'id_users_generalmaanager' => $this->input->post('id_users_generalmaanager',TRUE),
            ...
            $this->Investasi_generalmanager_model->insert($data);
    ...
    public function update_action() 
    {
		...
		'id_users_generalmaanager' => $this->input->post('id_users_generalmaanager',TRUE),
            ...
            $this->Investasi_generalmanager_model->update($this->input->post('investasi_id', TRUE), $data);
    ...
    public function status_disetujui($investasi_id) 
    {
            ...
            $this->Investasi_generalmanager_model->update($investasi_id, $data);
            $this->session->set_flashdata('message', 'Update Record Success');
            redirect(site_url('investasi'));
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Investasi_generalmanager_model->delete($id);
	...
	foreach ($this->Investasi_generalmanager_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'investasi_data' => $this->Investasi_generalmanager_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('investasi_generalmanager/investasi_doc',$data);
    }
