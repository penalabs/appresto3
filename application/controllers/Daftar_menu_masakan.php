...
class Daftar_menu_masakan extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        
        $this->load->model('Daftar_menu_masakan_model');
    ...
    {
        $this->template->load('template','daftar_menu_masakan/menu_masakan_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Daftar_menu_masakan_model->json();
    }

    public function read($id) 
    {
        $row = $this->Daftar_menu_masakan_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'id_users' => $row->id_users,
            ...
            $this->template->load('template','daftar_menu_masakan/menu_masakan_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('daftar_menu_masakan'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('daftar_menu_masakan/create_action'),
        ...
        $this->template->load('template','daftar_menu_masakan/menu_masakan_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'id_users' => $this->input->post('id_users',TRUE),
            ...
            $this->Daftar_menu_masakan_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('daftar_menu_masakan/update_action'),
    ...
    public function update_action() 
    {
		...
		'id_users' => $this->input->post('id_users',TRUE),
            ...
            $this->Daftar_menu_masakan_model->update($this->input->post('menu_masakan_id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Daftar_menu_masakan_model->delete($id);
	...
	foreach ($this->Daftar_menu_masakan_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'menu_masakan_data' => $this->Daftar_menu_masakan_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('daftar_menu_masakan/menu_masakan_doc',$data);
    }

}

/* End of file Daftar_menu_masakan.php */
/* Location: ./application/controllers/Daftar_menu_masakan.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2022-10-17 07:03:57 */
/* http://harviacode.com */