...
class Pemberian_biaya_operasional_cabang extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        
        $this->load->model('Pemberian_biaya_operasional_cabang_model');
    ...
    {
        $this->template->load('template','pemberian_biaya_operasional_cabang/biaya_operasional_cabang_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Pemberian_biaya_operasional_cabang_model->json();
    }

    public function read($id) 
    {
        $row = $this->Pemberian_biaya_operasional_cabang_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'status' => $row->status,
            ...
            $this->template->load('template','pemberian_biaya_operasional_cabang/biaya_operasional_cabang_read', $data);
        } else {
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('pemberian_biaya_operasional_cabang/create_action'),
        ...
        $this->template->load('template','pemberian_biaya_operasional_cabang/biaya_operasional_cabang_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'status' => $this->input->post('status',TRUE),
            ...
            $this->Pemberian_biaya_operasional_cabang_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('pemberian_biaya_operasional_cabang/update_action'),
    ...
    public function update_action() 
    {
		...
		'status' => $this->input->post('status',TRUE),
            ...
            $this->Pemberian_biaya_operasional_cabang_model->update($this->input->post('biaya_operasional_id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Pemberian_biaya_operasional_cabang_model->delete($id);
	...
	foreach ($this->Pemberian_biaya_operasional_cabang_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'biaya_operasional_cabang_data' => $this->Pemberian_biaya_operasional_cabang_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('pemberian_biaya_operasional_cabang/biaya_operasional_cabang_doc',$data);
    }
...
/* End of file Pemberian_biaya_operasional_cabang.php */
/* Location: ./application/controllers/Pemberian_biaya_operasional_cabang.php */
