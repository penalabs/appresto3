	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA PENGEMBALIAN_KAS_INVESTOR</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td>
						<?php echo cmb_dinamis_user('investor_id', 'tbl_user','owner','full_name', 'id_users', $id_users,'DESC') ?>

						</td>
					</tr>
	
					<tr>
						<td><input type="hidden" class="form-control" name="id_users" id="id_users" placeholder="Investor Id" value="<?php echo $this->session->userdata('id_users'); ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('pengembalian_kas_investor') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
