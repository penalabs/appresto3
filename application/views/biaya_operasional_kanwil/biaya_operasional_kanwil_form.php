	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA BIAYA_OPERASIONAL_KANWIL</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Kanwil Id <?php echo form_error('kanwil_id') ?></td>
						<td><?php echo cmb_dinamis('kanwil_id', 'resto', 'nama_resto', 'kanwil_id', $kanwil_id,'DESC') ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('biaya_operasional_kanwil') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
