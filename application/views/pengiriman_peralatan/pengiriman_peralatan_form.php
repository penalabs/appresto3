			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td>
						<?php echo cmb_dinamis_user('id_users_adminresto', 'tbl_user','adminresto', 'full_name', 'id_users', $id_users_adminresto,'DESC') ?>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('pengiriman_peralatan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
