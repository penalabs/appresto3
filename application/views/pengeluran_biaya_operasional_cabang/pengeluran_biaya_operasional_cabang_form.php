	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA PENGELURAN_BIAYA_OPERASIONAL_CABANG</h3>
			</div>
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('pengeluran_biaya_operasional_cabang') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
