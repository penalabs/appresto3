<div class="content-wrapper">
    <section class="content">
        ...
        <div class="col-xs-6">
			...
			<form action="<?php echo base_url();?>index.php/kasir_detial_pemesanan_masakan/filter" method="post">
			
				<table class='table table-bordered'>
                <input type="hidden" name="pemesanan_masakan_id2" id="pemesanan_masakan_id2" value="<?php echo $pemesanan_masakan_id; ?>" />
					<tr>
					...
					<tr>
						<td width='200'>Nama Pembeli </td><td><input type="text" class="form-control" name="nama_pembeli" id="nama_pembeli" placeholder="Nama Pembeli" value="<?php echo $nama_pembeli; ?>" /></td>
					</tr>
	
					<tr>
						<td width='200'>Id Users Waiter </td><td><input type="text" class="form-control" name="id_users_waiter" id="id_users_waiter" placeholder="Id Users Waiter" value="<?php echo $nama_waiter; ?>" /></td>
					</tr>
	
					<tr>
						<td width='200'>Total </td><td><input type="text" class="form-control" name="total" id="total" placeholder="Total" value="<?php echo $total; ?>" /></td>
					</tr>
	
					<tr>
						<td width='200'>Dibayar </td><td><input type="text" class="form-control" name="dibayar" id="dibayar" placeholder="Dibayar" value="<?php echo $dibayar; ?>" /></td>
					</tr>
	
					<tr>
						<td width='200'>Status </td><td><input type="text" class="form-control" name="status" id="status" placeholder="Status" value="<?php echo $status; ?>" /></td>
					</tr>
			...
			<form action="#" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Pemesanan masakan id </td><td><input type="text" class="form-control" name="pemesanan_masakan_id" id="pemesanan_masakan_id" placeholder="Pemesanan masakan id" value="<?php echo $pemesanan_masakan_id; ?>" /></td>
					</tr>
					...
					<tr>
						<td width='200'>Id Users Kasir </td><td><input type="text" class="form-control" name="id_users_kasir" id="id_users_kasir" placeholder="Id Users Kasir" value="" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<button type="button" id="bayar" onclick="bayarku();" class="btn btn-danger"><i class="fa fa-floppy-o"></i> LIHAT PEMBAYARAN</button> 
						</td>
					</tr>
        ...
        <script type="text/javascript">
            function load_table(pemesanan_masakan_id) {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/kasir_detial_pemesanan_masakan/json", "type": "POST",
                        'data': {
        ...
        $( document ).ready(function() {
            var pemesanan_masakan_id=$('#pemesanan_masakan_id2').val();
            alert(pemesanan_masakan_id);
            load_table(pemesanan_masakan_id);
