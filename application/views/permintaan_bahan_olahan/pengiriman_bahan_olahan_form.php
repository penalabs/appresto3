		...
		<div class="box box-warning box-solid">
			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td><input type="hidden" class="form-control" name="id_users_produksi" id="id_users_produksi" placeholder="Id Users Produksi" value="<?php echo $this->session->userdata('id_users'); ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('permintaan_bahan_olahan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
